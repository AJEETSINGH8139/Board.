            ...
            <div className='leftside-home'>
                ...
                <div className='leftside-button'>
                    <div className='btn'>
                        ...
                        <a className='style-btn' href='#'>Dashboard</a>
                    </div>
                    <div className='btn'>
                        <img className='style-btn' src={transaction} alt='transaction' />
                        <a className='style-btn' href='#'>Transactions</a>
                    </div>
                    <div className='btn'>
                        <img className='style-btn' src={schedule} alt='schedule' />
                        <a className='style-btn' href='#'>Schedules</a>
                    </div>
                    <div className='btn'>
                        <img className='style-btn' src={user} alt='user' />
                        <a className='style-btn' href='#'>Users</a>
                    </div>
                    <div className='btn'>
                        <img className='style-btn' src={setting} alt='setting' />
                        <a className='style-btn' href='#'>Settings</a>
                    </div>
                </div>
                <div className='leftside-bottum'>
                    <a className='bottum-btn' href='#'>Help</a>
                    <br />
                    <a className='bottum-btn' href='#'>Contact Us</a>
                </div>
            </div>
